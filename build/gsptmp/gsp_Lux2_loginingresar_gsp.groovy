...
class gsp_Lux2_loginingresar_gsp extends org.grails.gsp.GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/login/ingresar.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(6)
expressionOut.print(viewsaludo)
printHtmlPart(7)
})
...
public static final long LAST_MODIFIED = 1555085419688L
