...
class gsp_Lux2_usuariocreate_gsp extends org.grails.gsp.GroovyPage {
...
createTagBody(1, {->
printHtmlPart(1)
invokeTag('captureMeta','sitemesh',4,['gsp_sm_xmlClosingForEmptyTag':("/"),'name':("layout"),'content':("nuestro_main")],-1)
printHtmlPart(1)
...
invokeTag('form','g',35,['resource':(this.usuario),'method':("POST")],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1555046334517L
